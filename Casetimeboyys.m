...
ydogFinalB = dogFinalB;
    ...
    for i = 1:400
        for j = 1:400
            ydogFinalR(i,j) = floor( mod(dogFinalR(i,j),10) ./ 10);
    ...
    for i = 1:400
        for j = 1:400
            ydogFinalG(i,j) = floor( mod(dogFinalG(i,j),10) ./ 10);
    ...
    for i = 1:400
        for j = 1:400
            ydogFinalB(i,j) = floor( mod(dogFinalB(i,j),10) ./ 10);
